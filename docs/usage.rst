...
Here you can consult practical uses for some of the Doctor Hastie functions.
...
several operations to access the module information::
    ...
    from doctorhastie.bundle import Module
...
to as *Addons*. Here you can see how to interact with a bundle::
    ...
    from doctorhastie.bundle import Bundle
...
and ask for specific information about them. For example::
    ...
    from doctorhastie.environment import Environment
