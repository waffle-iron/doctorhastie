...
"""
``doctorhastie.cli`` is a module for handling the command line interface.

This module handles the commands for using Doctor Hastie. It also parses
...
def commandline(argv=None):
    ...
    parser.add_argument(
        ...
        version='doctorhastie {0:s}'.format(__version__),
